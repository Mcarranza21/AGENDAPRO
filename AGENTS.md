...
The create-event form writes to the single `eventos` table in Supabase. Do not add authentication, a second table, a backend, Google Calendar integration, or a chatbot for Delivery 3.
